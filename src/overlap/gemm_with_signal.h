...
public:
  ...
  EpilogueVisitorSignaling(
    ...
    iterator_D_(params.params_ND, params.ptr_D, reshape(problem_size), thread_idx, map_to_d(threadblock_offset)),
...
public:
  ...
  // Epilogue visitor
  using EpilogueVisitor = kernel::EpilogueVisitorSignaling<
    ThreadblockShape,
